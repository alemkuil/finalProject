...
//Name: alien.0009.ma
//Last modified: Wed, Mar 11, 2015 10:48:24 AM
//Codeset: UTF-8
requires maya "2015";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.4530551786894659 5.360118051265113 -10.8439045875157 ;
	setAttr ".r" -type "double3" -28.538352731295983 193.80000000023668 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 11.350800938887888;
...
createNode transform -n "eyeTarget";
	setAttr ".t" -type "double3" -0.31196205210479566 0.83163261594889271 0.011459012729101659 ;

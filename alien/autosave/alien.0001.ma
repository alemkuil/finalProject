...
//Name: alien.0001.ma
//Last modified: Thu, Mar 05, 2015 12:19:41 PM
//Codeset: UTF-8
requires maya "2015";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.73118064807885019 1.501822101030434 -6.0871259531816611 ;
	setAttr ".r" -type "double3" -1.5383527315363841 187.39999999999151 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 6.2093922088053448;

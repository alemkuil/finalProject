...
//Name: alien.0014.ma
//Last modified: Wed, Mar 11, 2015 03:59:37 PM
//Codeset: UTF-8
requires maya "2015";
currentUnit -l centimeter -a degree -t film;
fileInfo "exportedFrom" "/Users/alemkuil/Desktop/CIS 410/410Repo/alien.ma";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.090310116912399 6.8129696725216231 -13.438341954169335 ;
	setAttr ".r" -type "double3" -28.538352731295983 193.80000000023668 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 14.391849596699085;
...
createNode transform -n "alien";
	setAttr ".rp" -type "double3" -0.10119706392288208 1.1144182507292646 -1.6822645548730391 ;
	setAttr ".sp" -type "double3" -0.10119706392288208 1.1144182507292646 -1.6822645548730391 ;
createNode transform -n "pCube10" -p "alien";
...
createNode transform -n "pCube4" -p "alien";
...
createNode mesh -n "pCubeShape4" -p "pCube4";
	...
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "pCube6" -p "alien";
...
createNode mesh -n "pCubeShape6" -p "pCube6";
	...
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "pCube8" -p "alien";
...
createNode mesh -n "pCubeShape8" -p "pCube8";
	...
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "pCube7" -p "alien";
...
createNode mesh -n "pCubeShape7" -p "pCube7";
	...
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "pCube1" -p "alien";
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
createNode transform -n "pCube9" -p "alien";
...
createNode mesh -n "pCubeShape9" -p "pCube9";
	...
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "pCube3" -p "alien";
...
createNode transform -n "eyeTarget" -p "alien";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.12444905029095477 1.0445871702774325 0.023517981588900838 ;
...
createNode aimConstraint -n "eye_aimConstraint1" -p "eye";
	...
	setAttr ".rsrr" -type "double3" 2.3386507212387455 -1.4931194260272311 360.42056847737024 ;
	setAttr -k on ".w0";

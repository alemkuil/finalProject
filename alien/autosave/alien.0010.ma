...
//Name: alien.0010.ma
//Last modified: Wed, Mar 11, 2015 11:55:45 AM
//Codeset: UTF-8
requires maya "2015";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.1518554960573062 6.9532844798432647 -13.688909853797812 ;
	setAttr ".r" -type "double3" -28.538352731295983 193.80000000023668 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 14.685550722286239;
...
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" -6.6568284665465312 10.116026389780448 -4.6632028509463712 ;
	setAttr ".r" -type "double3" -130.3769290551981 -42.240906412012038 63.216135265441864 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	setAttr -k off ".v";
	setAttr ".in" 0.91743117570877075;
createNode transform -n "ambientLight1";
	setAttr ".t" -type "double3" 8.150623252887879 -0.77264458027722638 -3.4030531332703795 ;
createNode ambientLight -n "ambientLightShape1" -p "ambientLight1";
	setAttr -k off ".v";
	setAttr ".in" 0.60606062412261963;
	setAttr ".urs" no;
...
createNode mesh -n "pCubeShape10" -p "pCube10";
	...
	setAttr ".cvd" -type "dataPolyComponent" Index_Data Vertex 0 ;
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
createNode transform -n "eyeTarget";
	setAttr ".t" -type "double3" -0.076483757567902488 1.1250262315453057 0.11791665460459555 ;

...
//Name: alien.0007.ma
//Last modified: Thu, Mar 05, 2015 01:27:33 PM
//Codeset: UTF-8
requires maya "2015";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.42791703481349741 2.3316282223388303 -4.648602763951291 ;
	setAttr ".r" -type "double3" -21.338352731174655 186.59999999975975 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 4.4619652065284239;
...
createNode mesh -n "bodyShape" -p "body";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.17500000447034836 0.39166668057441711 ;

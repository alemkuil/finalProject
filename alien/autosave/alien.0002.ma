...
//Name: alien.0002.ma
//Last modified: Thu, Mar 05, 2015 12:29:43 PM
//Codeset: UTF-8
requires maya "2015";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -7.7459591045749434 1.3842949842047663 -2.8067479036492218 ;
	setAttr ".r" -type "double3" -0.33835273152892714 249.79999999997872 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 8.3265071268886786;
...
createNode transform -n "nurbsCircle1";
	setAttr ".t" -type "double3" 2.2463492768528317 0 -1.9787075349908685 ;
createNode nurbsCurve -n "nurbsCircleShape1" -p "nurbsCircle1";
	setAttr -k off ".v";
	setAttr ".tw" yes;
createNode transform -n "pSphere3";
	setAttr ".t" -type "double3" 2.717691528387614 1.575386656897082 -1.0816046939558828 ;
	setAttr ".s" -type "double3" 0.384708642776107 0.384708642776107 0.384708642776107 ;
